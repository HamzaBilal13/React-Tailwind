...
const Navbar = () => {
  ...
  <header className="absolute inset-x-0 top-0 z-50">
    <nav className="flex items-center justify-between p-6 lg:px-8 border-b shadow" aria-label="Global">
      ...
      <button class="btn btn-blue hidden lg:flex lg:flex-1 lg:justify-end" onClick={ ()=> setShowMyModal(true)}>
      
        <a className="text-sm font-semibold leading-6 bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">Login
